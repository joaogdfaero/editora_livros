...
class AssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assembly" do
    assert_difference("Assembly.count") do
      post assemblies_url, params: { assembly: { book_id: @assembly.book_id, name: @assembly.name, part_id: @assembly.part_id } }
    end
  ...
  test "should update assembly" do
    patch assembly_url(@assembly), params: { assembly: { book_id: @assembly.book_id, name: @assembly.name, part_id: @assembly.part_id } }
