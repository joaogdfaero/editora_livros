...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `joaogdfaero`, `editora_livros_rails`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
See the [open issues](https://github.com/joaogdfaero/editora_livros_rails/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/joaogdfaero/editora_livros_rails](https://github.com/joaogdfaero/editora_livros_rails)
